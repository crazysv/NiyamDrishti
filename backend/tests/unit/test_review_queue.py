...
def test_confidence_threshold_routing_in_rule_engine():
    ...
    mock_fields = [
        {"id": uuid.uuid4(), "field_type": "mrp", "raw_text": "MRP 150.00", "confidence": 0.80, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
        {"id": uuid.uuid4(), "field_type": "net_quantity", "raw_text": "500g", "confidence": 0.95, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
        {"id": uuid.uuid4(), "field_type": "manufacturer_address", "raw_text": "Mfg by ABC Ltd, Delhi 110001", "confidence": 0.92, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
        {"id": uuid.uuid4(), "field_type": "mfg_date", "raw_text": "01/2026", "confidence": 0.94, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
        {"id": uuid.uuid4(), "field_type": "consumer_care", "raw_text": "care@abc.com", "confidence": 0.96, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
        {"id": uuid.uuid4(), "field_type": "country_of_origin", "raw_text": "India", "confidence": 0.97, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
        {"id": uuid.uuid4(), "field_type": "commodity_name", "raw_text": "Tea", "confidence": 0.91, "bounding_box": {"h": 30}, "verdict": "pass", "reviewed_by_officer": False},
    ]
