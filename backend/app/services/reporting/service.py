    ...
    def _generate_fpdf_report(self, context: dict[str, Any]) -> bytes:
        ...
        if violations:
            ...
            for v in violations:
                ...
                pdf.set_text_color(86, 97, 85)
                # FPDF leaves the cursor at the right edge after multi_cell.
                # Reset it before the citation row so long violation entries
                # cannot render their citation outside the page boundary.
                pdf.set_x(15)
                pdf.cell(
                    0,
                    4,
