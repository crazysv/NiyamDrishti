...
> **Usage:** Set this file up as a custom slash command in your IDE (see "Where to put this" below), then run `/session-start` at the beginning of a new chat/session with your coding agent. It replaces manually re-explaining the project every time.
